...
#==========cleaning===============
NICEI_Tables_Q4_2022 <- read_excel("~/Documents/IDES/r/r-projects-main/NICEI-Tables-Q4-2022.xlsx",sheet = "Table 1")
...
df<-df[-1,]
df1<-df[,0:5]
colnames(df1)<-c("Year", "Quarter", "NICEI", "Private", "Public")
...
geom_line(data=df4, aes(x=date, y=value, group = 1), linewidth = 1)+final_plot
